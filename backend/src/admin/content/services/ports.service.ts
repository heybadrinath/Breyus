...
export class PortsService {
    ...
    if (dto.code && dto.code.toUpperCase() !== port.code) {
      ...
      if (existing) {
        throw new ConflictException(
          `Port with code ${dto.code} already exists`,
        );
      }
  ...
  async seedDefaultPorts() {
    ...
    const defaultPorts = [
      ...
      {
        code: 'INTUT',
        name: 'Tuticorin Port (V.O. Chidambaranar)',
        country: 'IN',
        type: 'sea',
        city: 'Tuticorin',
      },
      ...
      {
        code: 'VNSGN',
        name: 'Port of Ho Chi Minh (Cat Lai)',
        country: 'VN',
        type: 'sea',
      ...
      {
        code: 'SAJED',
        name: 'King Abdullah Port (Jeddah)',
        country: 'SA',
        type: 'sea',
        city: 'Jeddah',
      },
