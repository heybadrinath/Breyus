...
export class AnalyticsController {
  ...
  async getMetrics(
    ...
    try {
      ...
      const data = await this.analyticsService.getMetricsData(
        companyId,
        dateRange,
      );
  ...
  async getBarGraphData(
    ...
    try {
      ...
      const dateRange = getDateRangeFromQuery(query);
      const data = await this.analyticsService.getBarGraphData(
        companyId,
        dateRange,
      );
      response.status(HttpStatus.OK).send({
  ...
  async getScatterGraphData(
    ...
    try {
      ...
      const dateRange = getDateRangeFromQuery(query);
      const data = await this.analyticsService.getScatterGraphData(
        companyId,
        dateRange,
      );
      response.status(HttpStatus.OK).send({
  ...
  async getCountrySalesData(
    ...
    try {
      ...
      const dateRange = getDateRangeFromQuery(query);
      const data = await this.analyticsService.getCountrySalesData(
        companyId,
        dateRange,
      );
      response.status(HttpStatus.OK).send({
  ...
  async getSalesMetrics(
    ...
    try {
      ...
      const dateRange = getDateRangeFromQuery(query);
      const data = await this.analyticsService.getSalesMetricsData(
        companyId,
        dateRange,
      );
      response.status(HttpStatus.OK).send({
  ...
  async getTopProducts(
    ...
    try {
      ...
      const dateRange = getDateRangeFromQuery(query);
      const data = await this.analyticsService.getTopProductsData(
        companyId,
        dateRange,
      );
      response.status(HttpStatus.OK).send({
  ...
  async exportPdf(
    ...
    try {
      ...
      const dateRange = getDateRangeFromQuery(query);
      const html = await this.exportService.generatePdfHtml(
        companyId,
        dateRange,
      );
