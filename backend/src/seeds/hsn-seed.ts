...
const HSN_CODES = [
  ...
  {
    hsn_code: '0306',
    description: 'Crustaceans (lobsters, crabs, shrimps)',
    category: 'Fish & Seafood',
  },
  {
    hsn_code: '0307',
    description: 'Molluscs (oysters, scallops, mussels)',
    category: 'Fish & Seafood',
  },
  ...
  {
    hsn_code: '0403',
    description: 'Buttermilk, yogurt, kephir',
    category: 'Dairy',
  },
  {
    hsn_code: '0404',
    description: 'Whey and milk products',
    category: 'Dairy',
  },
  {
    hsn_code: '0405',
    description: 'Butter and dairy spreads',
    category: 'Dairy',
  },
  ...
  {
    hsn_code: '1008',
    description: 'Buckwheat, millet and other cereals',
    category: 'Cereals',
  },
  ...
  {
    hsn_code: '1202',
    description: 'Ground-nuts (peanuts)',
    category: 'Oil Seeds',
  },
  ...
  {
    hsn_code: '1205',
    description: 'Rape or colza seeds',
    category: 'Oil Seeds',
  },
  { hsn_code: '1206', description: 'Sunflower seeds', category: 'Oil Seeds' },
  {
    hsn_code: '1207',
    description: 'Other oil seeds (sesame, mustard, safflower)',
    category: 'Oil Seeds',
  },
  ...
  {
    hsn_code: '1512',
    description: 'Sunflower-seed or safflower oil',
    category: 'Vegetable Oils',
  },
  {
    hsn_code: '1513',
    description: 'Coconut or palm kernel oil',
    category: 'Vegetable Oils',
  },
  {
    hsn_code: '1514',
    description: 'Rape, colza or mustard oil',
    category: 'Vegetable Oils',
  },
  {
    hsn_code: '1515',
    description: 'Other vegetable fats and oils',
    category: 'Vegetable Oils',
  },
  ...
  {
    hsn_code: '1702',
    description: 'Other sugars (glucose, fructose)',
    category: 'Sugar',
  },
  ...
  {
    hsn_code: '0908',
    description: 'Nutmeg, mace, cardamoms',
    category: 'Coffee, Tea & Spices',
  },
  {
    hsn_code: '0909',
    description: 'Seeds of anise, cumin, caraway',
    category: 'Coffee, Tea & Spices',
  },
  {
    hsn_code: '0910',
    description: 'Ginger, saffron, turmeric, thyme',
    category: 'Coffee, Tea & Spices',
  },
  ...
  {
    hsn_code: '0804',
    description: 'Dates, figs, pineapples, avocados, mangoes',
    category: 'Fruits',
  },
  {
    hsn_code: '0805',
    description: 'Citrus fruit (oranges, lemons)',
    category: 'Fruits',
  },
  ...
  {
    hsn_code: '0708',
    description: 'Leguminous vegetables (peas, beans)',
    category: 'Vegetables',
  },
  ...
  // Mineral Fuels
  {
    ...
    category: 'Mineral Fuels',
  },
  {
    hsn_code: '2704',
    description: 'Coke and semi-coke of coal',
    category: 'Mineral Fuels',
  },
  {
    hsn_code: '2709',
  ...
  {
    hsn_code: '2710',
    description: 'Petroleum oils, refined',
    category: 'Mineral Fuels',
  },
  {
    hsn_code: '2711',
    description: 'Petroleum gases (LPG, natural gas)',
    category: 'Mineral Fuels',
  },
  ...
  {
    hsn_code: '2606',
    description: 'Aluminium ores (bauxite)',
    category: 'Ores & Minerals',
  },
  {
    hsn_code: '2607',
  ...
  {
    hsn_code: '2804',
    description: 'Hydrogen, nitrogen, oxygen',
    category: 'Chemicals',
  },
  ...
  {
    hsn_code: '3103',
    description: 'Mineral or chemical phosphatic fertilisers',
    category: 'Chemicals',
  },
  {
    hsn_code: '3104',
    description: 'Mineral or chemical potassic fertilisers',
    category: 'Chemicals',
  },
  ...
  {
    hsn_code: '4401',
    description: 'Fuel wood, wood chips',
    category: 'Wood & Paper',
  },
  {
    hsn_code: '4403',
  ...
  {
    hsn_code: '4407',
    description: 'Wood sawn or chipped',
    category: 'Wood & Paper',
  },
  {
    hsn_code: '4703',
  ...
  {
    hsn_code: '4802',
    description: 'Uncoated paper for writing/printing',
    category: 'Wood & Paper',
  },
  ...
  {
    hsn_code: '3904',
    description: 'Polymers of vinyl chloride (PVC)',
    category: 'Plastics',
  },
  {
    hsn_code: '3907',
