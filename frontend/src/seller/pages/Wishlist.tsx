/**
 * Seller Wishlist Page
 * Displays seller's saved AI contacts (buyers) and favourite companies
 * - Contacts tab: AI-discovered buyers saved for later contact
 * - Companies tab: Favourite buyer companies on the platform
 */
...
const SellerWishlist: React.FC = () => {
  const navigate = useNavigate();
  const [searchParams, setSearchParams] = useSearchParams();
  const { showToast } = useNotifications();

  // Tab state from URL - default to contacts for sellers
  const currentTab = (searchParams.get('tab') as TabType) || 'contacts';
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="px-6 py-6 max-w-7xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-1">Your saved AI contacts and favourite companies</p>
        </div>
                ...
                {contactsLoading ? (
                  ...
                  <div className="flex flex-col items-center justify-center py-16">
                    ...
                    <p className="text-gray-600 mb-4 text-center max-w-md">
                      Use Breyus AI to discover potential buyers and save them here for later
                    </p>
                    <button
                          ...
                          <div className="flex items-start justify-between">
                            <div className="flex-1 min-w-0">
                              ...
                              <span className="inline-flex items-center gap-1 mt-1 text-xs font-medium px-2 py-0.5 rounded-full bg-green-100 text-green-700">
                                {contact.role === 'buyer' ? 'Buyer' : 'Seller'}
                              </span>
                            </div>
                            <button
                ...
                {companiesLoading ? (
                  ...
                  <div className="flex flex-col items-center justify-center py-16">
                    ...
                    <p className="text-gray-600 mb-4 text-center">
                      Browse buyer profiles and add them to your favourites
                    </p>
                    <button
                      ...
                      >
                        ...
                        <div className="p-4 relative">
                          ...
                          <div className="absolute -top-8 left-4">
                            <div className="w-16 h-16 rounded-full bg-white border-4 border-white shadow-md overflow-hidden flex items-center justify-center bg-gradient-to-br from-green-500 to-emerald-600">
                          ...
                          <div className="mt-10">
                            ...
                            {/* View Profile Button */}
                            <button
                              onClick={() => navigate(`/seller/buyer-profile/${company.companyId}`)}
