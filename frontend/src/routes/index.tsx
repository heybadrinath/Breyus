...
const AppRoutes = () => {
  ...
  return (
    <AnimatePresence mode="wait">
          ...
          <Route path="/buyer/homepage" element={<Animate page={<BuyerLayout children={<Homepage />} />} />} />
          ...
          <Route path="/buyer/trade" element={<Animate page={<BuyerLayout children={<BuyerTrade />} />} />} />
          {/* Seller Routes */}
