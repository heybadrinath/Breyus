                ...
                {!uploadSuccess && (
                    <div className="p-4 border-t bg-gray-50 flex gap-3">
                        ...
                        <button
                            ...
                            className="flex-1 py-2 px-4 bg-black text-white rounded-lg hover:bg-gray-800 transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                        >
                            {uploading ? (
                                <>
