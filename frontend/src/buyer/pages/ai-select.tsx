...
import { Search, ChevronRight, Package, Sparkles, Database, ArrowLeft } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Select Commodity</h1>
