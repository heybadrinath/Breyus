...
Retrieves a public company profile by ID. Returns only non-sensitive fields visible to other users. Validates that the company is a seller before returning.
...
{
  "statusCode": 404,
  "message": "Company not found or is not a seller"
}
```
...
Retrieves public profile for a buyer company. Used by sellers viewing buyer profiles.
...
{
  "statusCode": 404,
  "message": "Company not found or is not a buyer"
}
```
